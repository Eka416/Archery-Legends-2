...
function setup() {
  ...
  player = createSprite(100,height-250)
  player.addImage(playerImg)
  player.scale = 0.1

  archer = new Archer(200,height-300,120,120)
